...
// The body of the function should create an empty array stored in a variable. The function should also contain a
// for loop which loops over the array of musicians. You'll want to be careful about what value you set your counter
// variable to store. (Hint: Think about what the first index of an array is). The first time through the loop,
// the body of the loop should create a string using the first index of the musicians array and the first index
// of the instruments array: "John Lennon plays guitar". This string should be added to the empty array you created.
...
function theBeatlesPlay(musicians, instruments) {
  ...
  for (var i = 0; i < musicians.length; i++) {
    for (var j = 0; j < instruments.length; j++) {
      if (i === j) {
        var text = musicians[i] + " plays " + instruments[j];
        array.push(text);
      }
    }
  }
